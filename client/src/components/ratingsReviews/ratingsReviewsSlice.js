...
export const markHelpful = createAsyncThunk(
  ...
  async (reviewId, thunkAPI) => {
    await axios.put(`http://ec2-18-220-58-182.us-east-2.compute.amazonaws.com/api/reviews/${reviewId}/helpful`);
    return reviewId;
  }
);
...
export const reportReview = createAsyncThunk(
  'reviews/report',
  async (reviewId, thunkAPI) => {
    await axios.put(`http://ec2-18-220-58-182.us-east-2.compute.amazonaws.com/api/reviews/${reviewId}/report`);
    return reviewId;
  }
);
